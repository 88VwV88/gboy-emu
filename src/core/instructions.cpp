                ...
                case 0x9:
                    switch ((_opcode & 0x0F)) {
                        ...
                        case 0xE: // 0x9E SBC A, [HL]
                        {
                            ...
                            // half carry flag
                            if ((acc & 0xF) - (bus.at(value_u16) & 0xF) - ((flags & CARRY_FLAG) ? 1 : 0) < 0)
                                flags |= HALF_FLAG;
                            else
                                flags &= ~HALF_FLAG;
                ...
                case 0xA:
                        ...
                        switch(_opcode & 0xF){
                            ...
                            case 0x4: // CALL NZ, nn
                            {
                                if(!(flags & ZERO_FLAG))
                                {
                                    value_u16 = __fetch_next() | __fetch_next() << 8;
                                    set_sp(get_sp().SP - 2);
                                    bus.at(get_sp().SP) = (get_pc() & 0xFF);
                                    bus.at(get_sp().SP + 1) = (get_pc() >> 8) & 0xFF;
                                    set_pc(value_u16);
                                }
                                else
                                    set_pc(get_pc() + 3);
                            ...
                            {
                                set_sp(get_sp().SP - 2);
                                bus.at(get_sp().SP) = get_bc().C;
                                bus.at(get_sp().SP + 1) = get_bc().B;
                            }
                            break;
                            ...
                            case 0x7: // RST 00
                            {
                                set_sp(get_sp().SP - 2);
                                value_u16 = get_pc() + 1;
                                bus.at(get_sp().SP) = (value_u16 & 0xFF);
                                bus.at(get_sp().SP + 1) = (value_u16 >> 8) & 0xFF;
                                set_pc(0x00);
                            }
                            break;
                            ...
                            case 0xF: // RST 08
                            {
                                set_sp(get_sp().SP - 2);
                                value_u16 = get_pc() + 1;
                                bus.at(get_sp().SP) = (value_u16 >> 8) & 0xFF;
                                bus.at(get_sp().SP + 1) = value_u16 & 0xFF;
                                set_pc(0x08);
                            }
                            break;
                        }
                    ...
                    case 0xD:
                        switch(_opcode & 0xF){
                            ...
                            {
                                set_sp(get_sp().SP - 2);
                                bus.at(get_sp().SP) = get_de().D;
                                bus.at(get_sp().SP + 1) = get_de().E;
                            }
                            break;
                    ...
                    case 0xE:
                        switch(_opcode & 0xF){
                            ...
                            {
                                value_u8 = __fetch_next();
                                bus.at(0xFF00 + value_u8) = get_acc();
                            }
                            break;
                            ...
                            case 0x2: // LD (C), A
                            {
                                bus.at(0xFF00 + get_bc().C) = get_acc();
                            }
                            break;
                            ...
                            {
                                set_sp(get_sp().SP - 2);
                                bus.at(get_sp().SP) = get_hl().H;
                                bus.at(get_sp().SP + 1) = get_hl().L;
                            }
                            break;
                            ...
                            {
                                s8 offset = static_cast<int8_t>(__fetch_next());
                                u16 sp = get_sp().SP;
                    ...
                    case 0xF:
                        switch(_opcode & 0xF){
                            ...
                            {
                                set_sp(get_sp().SP - 2);
                                bus.at(get_sp().SP) = get_acc() & 0xFF;
                                bus.at(get_sp().SP + 1) = (get_acc() >> 8) & 0xFF;
                            }
                            break;
